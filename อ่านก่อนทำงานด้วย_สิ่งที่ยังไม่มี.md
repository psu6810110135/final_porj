...
- `admin.controller.ts` ยังไม่มี guard/role guard จริง (comment ไว้)
- `payments.controller.ts` endpoint สำคัญยังไม่บังคับ JWT/Role
...
- payment entity ยังไม่มี `reject_reason` และระบบยังไม่ persist เหตุผลปฏิเสธ
